...
Not sure if you're close? The [earnings calculator](/calculators/earnings-calculator) can help you model what your earnings would look like once you're in. For a step-by-step walkthrough of the application process, see the [how to join the Creator Rewards Program guide](/guides/how-to-join-creativity-program).
...
The RPM spread between niches is real and significant. For a deeper look at exact pay rates and what drives them, see our guide on [how much TikTok pays per view](/guides/how-much-does-tiktok-pay-per-view). A finance creator and a dance creator can post identical-length videos with identical total views and one earns 4–8x more than the other. This isn't arbitrary — it reflects advertiser demand. Advertisers pay more to reach users interested in finance than users watching dance compilations.
...
TikTok added a Search component to RPM in 2024, and it's one of the most underreported aspects of the program. Content that surfaces via TikTok's search feature — not the For You Page — reportedly earns a significantly higher rate per qualified view. Creators in community discussions report search-discovered views earning 2–5x the base FYP rate. TikTok has not made an official announcement about the rate difference, but the pattern is consistent across multiple creator communities.
...
The 60-ish day lag is frustrating but it's consistent. Budget your expectations accordingly — what you earn in January won't hit your account until March. For the full breakdown of [payment dates and how to set up your payout method](/guides/tiktok-creator-rewards-payment-schedule), we have a dedicated guide.
...
What TikTok has not done: officially publish a timeline for expanding CRP to Canada, Australia, or other excluded markets. One area that did evolve is the Additional Reward bonus system, where the [original 2025 criteria for earning additional rewards](/guides/additional-reward-criteria-2025) laid the groundwork for how TikTok now evaluates content quality for bonus payouts.
...
Ready to calculate what your current views would earn? Use the [earnings calculator](/calculators/earnings-calculator) to model your expected monthly earnings.
