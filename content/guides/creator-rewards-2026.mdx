...
Not sure if you're close? The [RPM calculator](/calculator) can help you model what your earnings would look like once you're in. For a step-by-step walkthrough of the application process, see the [how to join the Creator Rewards Program guide](/guides/how-to-join-creativity-program).
