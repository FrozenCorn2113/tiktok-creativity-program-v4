...
**Use the [earnings calculator](/calculators/earnings-calculator) to model your specific numbers.** Enter your view count, niche, and audience geography — you'll get a more useful estimate than any single number in this guide.
...
The [earnings calculator](/calculators/earnings-calculator) on this site lets you enter your view volume, niche, and audience geography. It's the fastest way to model what different content scenarios would actually earn.
...
This is why your monthly earnings can fluctuate noticeably even when your qualified view count is stable. It's not necessarily RPM dropping — it can be Additional Rewards varying. Both layers pay in the same monthly payment on the 15th. For details on what triggers the Additional Reward bonus and how to qualify, see the [Additional Reward criteria guide](/guides/additional-reward-criteria-2026).
...
For payment timing and how to set up your payment method, see the [Creator Rewards payment schedule guide](/guides/tiktok-creator-rewards-payment-schedule). And once you understand the numbers, the [payout timeline guide](/guides/payout-timeline) explains when TikTok actually sends the money.
