...
**The completion rate bar went up.** Multiple industry analyses suggest TikTok's threshold for pushing a video into wider distribution increased to around 70% completion rate, up from roughly 50% in earlier years. This is consistent industry reporting, not TikTok's published formula. Shorter videos with high completion rates distribute more widely than longer videos where viewers leave early.
