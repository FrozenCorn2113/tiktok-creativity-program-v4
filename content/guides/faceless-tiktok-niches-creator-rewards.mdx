...
<CalloutBox type="warning" title="AI labeling requirement">
  TikTok requires creators to label AI-generated content using the platform's built-in AI content label. Failing to label AI content can result in removal from Creator Rewards entirely, even if the content would otherwise qualify. For the complete breakdown of what's allowed and what isn't, read our [TikTok AI content monetization policy guide](/guides/tiktok-ai-content-monetization-policy).
</CalloutBox>

The safe approach for faceless creators: use AI as an assistant (scripting, research, voiceover, editing), but make sure the creative direction, unique angle, and editorial decisions are clearly human-driven. Record your own voiceover when possible. Add your own analysis rather than letting AI generate the full script verbatim. For a full roundup of which AI tools are worth using in your workflow, see our guide to the [best AI creative tools for TikTok creators](/guides/best-ai-creative-tools-tiktok-creators).
