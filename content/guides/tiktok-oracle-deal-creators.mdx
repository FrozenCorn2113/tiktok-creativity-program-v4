...
## Infrastructure Problems Since the Sale

The Oracle transition has not been smooth. Two data center outages have already hit TikTok U.S. since the USDS Joint Venture closed in January 2026.

The first happened in January, shortly after the deal closed. The second hit on March 3, 2026 and lasted approximately 20 hours. That outage was traced to Oracle's Ashburn, Virginia facility, which handles U.S. East region traffic. During that window, creators reported being unable to upload videos and seeing inaccurate view counts. (Sources: TechCrunch, The Register.)

These outages are infrastructure growing pains from migrating a platform of TikTok's scale onto new cloud systems. Oracle's stake in the USDS joint venture is approximately $2 billion, per a March 11, 2026 SEC filing reported by CNBC. That is a serious financial commitment, and Oracle has strong incentive to stabilize the infrastructure. But two outages in six weeks is not a clean transition.

### What creators are reporting on earnings

Creators across multiple communities have reported significant RPM drops since the sale closed in late January. Some describe earnings that are a fraction of what they made on comparable view counts before the deal. These reports come from creator communities and have been aggregated by outlets covering the creator economy. TikTok has not confirmed the scale or cause of these drops.

The most common explanation in creator communities is that the algorithm retraining on U.S.-based Oracle-hosted data is disrupting normal distribution and earnings patterns. The outages may also be contributing. Whether the drops are caused by the algorithm retrain, the outages, policy changes, or some combination has not been determined in any primary source reviewed.

What that means for you: if your RPM dropped sharply after January 22, 2026, you are likely seeing the same pattern others are reporting. It is not a problem specific to your account.

### What to do if your earnings dropped

**Lean into TikTok Shop.** Creator Rewards is one income stream, and right now it is the most exposed to the ongoing transition instability. TikTok Shop affiliate commissions operate on a separate mechanism from the Creator Rewards pool. If you have not already set up Shop affiliate links on products relevant to your niche, now is the time.

**Reduce sole dependency on Creator Rewards.** Creators who built their income around Creator Rewards as the primary source are feeling this the hardest. The current period is a strong argument for treating Creator Rewards as supplemental income rather than a salary replacement. The [multiple revenue streams guide](/guides/multiple-revenue-streams) covers how to structure this.

**Keep posting.** Pausing content during a low-RPM period compounds the problem. Your qualified view count drops, your algorithmic momentum weakens, and you earn nothing. A lower RPM on active content beats zero views on content you didn't post.

**Watch the 60-day mark.** If RPM does not recover by late March or April for most creators, that would suggest the drop is structural rather than transitional. Community reporting has been consistent since late January, so this is worth tracking over the next month.
