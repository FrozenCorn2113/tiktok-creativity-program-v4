...
<ComparisonTable
  ...
  rows={[
    ["Status", "Ended (late 2023)", "Active"],
    ["Pay model", "Per total view", "Per qualified view"],
    ["Video length requirement", "No minimum", "1 minute minimum"],
    ["Follower requirement", "10,000", "10,000"],
    ["View requirement (30 days)", "100,000", "100,000"],
    ["Reported RPM range", "$0.02–$0.04 per 1K views (self-reported; TikTok did not publish official figures)", "Higher ceiling (varies by niche, region, and content; no published benchmark)"],
    ["Account type", "Personal only", "Personal only"],
