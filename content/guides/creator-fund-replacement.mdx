...
<CalloutBox type="info" title="Quick summary">
  <ul>
    <li>The Creator Fund closed in late 2023 in the US, UK, France, and Germany [UNVERIFIED — verify exact closure date and regions on TikTok's official newsroom]</li>
...
<ComparisonTable
  ...
  rows={[
    ...
    ["Reported RPM range", "$0.02–$0.04 per 1K views [UNVERIFIED]", "Higher ceiling [UNVERIFIED]"],
...
No. The Creator Fund is no longer active. Payments that were accrued before the closure should have been paid out [UNVERIFIED — contact TikTok support if you believe you have unpaid Creator Fund earnings].
...
No. It's available in a limited set of regions [UNVERIFIED — TikTok has expanded the list over time; verify the current list of supported countries at TikTok's official Creator Portal]. If your country isn't supported, you cannot currently enroll.
