...
Creator Rewards income is taxable income. For the full breakdown, see our [creator tax guide](/guides/creator-tax-guide-2026). How that works depends on where you live.
...
The [earnings calculator](/calculators/earnings-calculator) lets you model expected earnings based on your view volume, niche, and audience geography. It's useful for planning — especially when you're close to the $50 threshold and want to know if your current month is likely to pay out.
