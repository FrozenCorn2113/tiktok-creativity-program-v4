...
The key insight: TikTok doesn't officially restrict product tags from also earning Creator Rewards RPM, and many creators do run both at once. That said, community reports widely suggest that adding product tags to a video reduces or eliminates its CRP earnings on that video, even though TikTok has not documented this officially. See the [TikTok Shop creator restrictions guide](/guides/tiktok-shop-creator-restrictions-creator-rewards) for full detail on what's known and what isn't.
...
TikTok has a Pilot Program that may allow creators with fewer than 5,000 followers to access Shop affiliate features in some regions. Check your Creator Center for current access eligibility.
...
These ranges are based on publicly listed commission rates from TikTok Shop sellers. Individual rates vary by seller and may change.
...
TikTok has not officially documented any penalty for adding product tags. However, community reports widely suggest that adding product tags to a video reduces or eliminates its CRP earnings on that video. Until TikTok clarifies this officially, treat the two programs as competing on the same video rather than complementary. For a full breakdown of what's confirmed versus reported, see the [TikTok Shop creator restrictions guide](/guides/tiktok-shop-creator-restrictions-creator-rewards).
...
**Are product options shrinking in Open Collaboration?**
As of March 31, 2026, all US sellers must use TikTok Shop Logistics Services exclusively for order fulfillment. Some sellers, particularly smaller operations, are pulling back or exiting the platform rather than switching logistics providers. This may reduce the number of products available in Open Collaboration, especially in categories where independent sellers were most active. If you notice fewer product options in your niche, Target Collaborations and direct brand outreach become more important for maintaining your affiliate income.
...
For details on which video formats and features disqualify content from Creator Rewards (including product tag implications), see the [TikTok Shop Creator Restrictions and Non-Interactive Video Rules guide](/guides/tiktok-shop-creator-restrictions-creator-rewards).
