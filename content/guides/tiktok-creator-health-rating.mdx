...
TikTok introduced in-app quizzes about Community Guidelines and platform policies. Completing these quizzes adds points to your CHR. The exact point value of quiz completions has not been documented. Multiple sources confirm the quizzes exist and contribute to the score, but the specific weighting is unclear.
