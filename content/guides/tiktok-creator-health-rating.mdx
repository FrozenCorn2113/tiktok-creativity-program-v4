...
The system was initially built around TikTok Shop enforcement, but it affects your broader account standing too. Whether CHR directly impacts Creator Rewards Program eligibility has not been explicitly confirmed by TikTok. The systems may operate separately, but account-level violations likely affect both.
...
TikTok has not published the exact tier thresholds. The following breakdown is based on available reporting and may not reflect the precise cutoff points.
...
| 200-399 | At Risk | Feature restrictions likely, monetization may be limited. Note: 200 is also the reset floor — the score accounts return to after serious violations are resolved. |
...
### Completing TikTok's policy quizzes

TikTok introduced in-app quizzes about Community Guidelines and platform policies. Completing these quizzes adds points to your CHR. The exact point value per quiz has not been documented publicly, but multiple creator reports confirm they contribute to the score.

The quizzes serve two purposes. Before any violation, they're a way to proactively build your score. After a violation, TikTok may prompt you to complete quizzes tied to the specific policy you breached, and completing those quizzes is one of the primary ways to earn points back. Check your dashboard regularly. The quizzes appear in Creator Tools and cover intellectual property, harmful content policies, and commerce guidelines.
...
### Direct impact on TikTok Shop commissions

The CHR was built specifically for TikTok Shop enforcement. Its most direct effect is on your Shop access and commission rates. A score in the At Risk or Critical range can trigger product listing restrictions, reduced Shop visibility, and eventual removal from the Shop program.

Creator Rewards payouts are calculated separately and are not directly tied to your CHR. That said, CHR violations often originate from the same account-level problems that can affect your general standing with TikTok. A Critical CHR score indicates serious policy violations, and those same violations can affect Creator Rewards eligibility through TikTok's broader account standing requirements. The two systems are related but not the same.
...
The exact navigation path may vary by app version and region. TikTok launched new Safety Center pages in March 2026 that include "Account status" and "Report records," which provide more visibility into your standing and enforcement history.
...
Go through every quiz TikTok offers in your creator dashboard. These quizzes are designed specifically for post-violation recovery: TikTok uses them to confirm you understand the policy you violated before restoring points to your score. If you have recent violations, check your dashboard first — TikTok may surface quiz prompts tied directly to those violation types. Complete all of them. They're the fastest legitimate way to recover points.
