...
Reported RPM figures vary widely. Some creators report $0.40–$0.60 per 1,000 qualified views; others report higher figures in certain niches and lower figures in others. TikTok does not publicly publish RPM benchmarks by category, so all figures in circulation are self-reported and difficult to verify.
...
General benchmarks for brand deals (self-reported, widely cited, not guaranteed):
...
<ComparisonTable
  ...
  rows='[["Pay structure", "Per qualified view (RPM)", "Flat fee per post/campaign"], ["Predictability", "Monthly, based on views", "Variable - you find and close deals"], ["Effort to start", "Apply once, passive after", "Ongoing outreach, negotiation"], ["Income floor at 50K followers", "Low without strong view counts", "Higher per-post at this stage"], ["Income ceiling", "Scales with qualified views", "Scales with follower count + engagement"], ["Content constraints", "1 minute minimum; specific formats", "Brand requirements per deal"], ["Time to first payment", "30+ days after first month", "Negotiated - often 30-90 days post-posting"], ["Exclusivity", "None", "Some deals include exclusivity clauses"]]'
/>
...
The [TikTok Oracle deal](/guides/tiktok-oracle-deal-creators) is another factor worth tracking, as the evolving US ownership structure could affect both platform monetization and brand advertising budgets on TikTok.
...
Yes. Paid brand partnership disclosure is required by the FTC regardless of whether you're also in CRP. FTC disclosure rules do change, so verify current requirements at ftc.gov. The two are separate disclosures.

**What's a realistic total income combining both at 100K followers?**
Highly variable. As a rough directional estimate based on widely cited creator benchmarks: a creator at 100K followers with consistent qualified views and 2 brand deals per month might earn $200–$500/month from CRP and $1,000–$3,000/month from brand deals. Individual results vary significantly based on niche, engagement, and negotiating ability.
