...
This guide covers how TikTok search works, how to find the right keywords, and how to optimize every element of your videos for search discovery. For the broader picture of how TikTok decides what to show viewers, see our [2026 algorithm guide](/guides/tiktok-algorithm-2026).
...
Videos with high search value may earn a higher RPM because they signal topical authority and attract intent-driven viewers. Advertisers pay more to reach someone actively researching a topic than someone passively scrolling. The exact weight of search value in the RPM calculation is not published and likely varies by niche.
...
Note: one agency study claims videos with on-screen text rank 400% higher in search, but no primary study supports this specific number. Use on-screen text because it's a confirmed indexable signal, not because of this unsubstantiated statistic.
...
- **Saves.** A strong indicator of useful content. Commonly cited as a ranking factor across creator communities, though TikTok has not officially confirmed the specific weight.
...
Content gaps are the gold mine. These are search terms where viewers want answers and nobody has made a strong video yet. If you find a content gap in your niche, you can rank with almost zero competition. For a full walkthrough of how to use this tool effectively, see our dedicated [TikTok Creator Search Insights guide](/guides/tiktok-creator-search-insights).
...
TikTok has not made an official statement on whether hashtag order affects ranking. Most SEO guides recommend placing your most relevant hashtag first, but there is no confirmed evidence that order changes ranking.
...
Some creators report that keywords in pinned comments are indexed for search. There is no official confirmation from TikTok on this. Worth testing in your own content, but do not rely on it as a primary strategy.
