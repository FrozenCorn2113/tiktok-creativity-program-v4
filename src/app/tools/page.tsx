...
const equipmentTools = [
  {
    ...
    priceRange: "Typically $20-60",
    ctaText: "See Our Top Picks",
    ctaUrl: "/guides/best-ring-lights-tiktok",
    imageUrl: "/images/guides/hero-best-ring-lights-tiktok.webp",
    internal: true,
    isEditorsPick: false,
  },
  {
    toolName: "Microphones",
    slug: "microphone",
    domain: "amazon.com",
    review:
    ...
    ctaText: "See Our Top Picks",
    ctaUrl: "/guides/best-microphones-tiktok",
    imageUrl: "/images/guides/hero-best-microphones-tiktok.webp",
    internal: true,
    isEditorsPick: true,
  },
  {
    ...
    priceRange: "Typically $15-40",
    ctaText: "See Our Top Picks",
    ctaUrl: "/guides/best-tripods-tiktok",
    imageUrl: "/images/guides/hero-best-tripods-tiktok.webp",
    internal: true,
    isEditorsPick: false,
  },
  {
    ...
    domain: "amazon.com",
    review:
      "Most creators start with their phone camera, and that's fine. But if you're ready to upgrade, a dedicated camera gives you better low-light performance, more control over depth of field, and sharper footage. The investment only makes sense if you're posting consistently and your content quality is the bottleneck, not your content strategy.",
    bestFor: "Creators who've outgrown phone cameras and want cinematic quality",
    priceRange: "Entry-level $300-800",
    ctaText: "See Our Top Picks",
    ctaUrl: "/guides/best-cameras-tiktok-creators",
    imageUrl: "/images/guides/hero-best-cameras-tiktok-creators.webp",
    internal: true,
    isEditorsPick: false,
  },
];
